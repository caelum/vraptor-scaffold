...
require File.dirname(__FILE__) + '/generators/scaffold/freemarker_generator/freemarker_generator'
require File.dirname(__FILE__) + '/generators/scaffold/jsp_generator/jsp_generator'