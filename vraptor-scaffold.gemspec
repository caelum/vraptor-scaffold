...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "lib/generators/app_generator/dependency.rb",
     "lib/generators/app_generator/dependency_manager.rb",
     "lib/generators/app_generator/freemarker_template_engine.rb",
     "lib/generators/app_generator/jsp_template_engine.rb",
     "lib/generators/app_generator/templates/build.gradle.erb",
     ...
     "lib/generators/app_generator/templates/eclipse/classpath.erb",
     ...
     "lib/generators/app_generator/templates/ivy-2.2.0.jar",
     ...
     "spec/lib/generators/app_generator/templates/build.gradle",
     "spec/lib/generators/app_generator/templates/build.properties",
     "spec/lib/generators/app_generator/templates/build_spring3.gradle",
     ...
     "spec/lib/generators/app_generator/templates/ivy_spring3.xml",
     "spec/lib/generators/app_generator/templates/pom.xml",
     "spec/lib/generators/app_generator/templates/pom_spring3.xml",
  ...
  s.post_install_message = %q{Thank you for installing vraptor-scaffold. Please read http://github.com/caelum/vraptor-scaffold/blob/master/README.textile for more information.}
